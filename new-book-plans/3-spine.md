...
|---|---|---|---|---|
| computed from the constitution | **85** | **41** | **1559** | **7** |
...
Evidence predicates (43), the complete list of what the world may report: `adjust`, `at`, `attack`, `authorized`, `born`, `broken`, `capture`, `carries`, `challenge`, `choose`, `cite`, `clear`, `continue`, `cruel`, `date`, `deceive`, `endorses`, `family`, `forgive`, `free`, `hears`, `home`, `injure`, `judge`, `limit`, `list`, `married`, `observe`, `parent`, `passport`, `pay`, `permanent`, `public`, `put`, `ratifies`, `receives`, `replace`, `rotten`, `show`, `sibling`, `suggest`, `teaches`, `work`.
...
Regenerated by `./verify.sh --refresh spine`, which reads the constitution directly. Do not edit
