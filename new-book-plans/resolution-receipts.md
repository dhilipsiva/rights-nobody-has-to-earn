...
**How the former attack is rerun.** `new-book-plans/counterfactual/unguarded-pen.pins.nibli`
...
**How the former attack is rerun.** `new-book-plans/counterfactual/no-missing-kinship-independence.pins.nibli`
...
**How the former attack is rerun.** `new-book-plans/counterfactual/no-first-contact-standing.pins.nibli`
...
**How the former attack is rerun.** `new-book-plans/counterfactual/undelivered-marker.pins.nibli`
...
**How the former attack is rerun.** `new-book-plans/reader-coverage.md`
