...
PROSE_AGGREGATE_SHA256 = "bfb4789b9c24b236d95c26f50448221000491c0d8e1161cd8089bbca7db1ec26"
...
# approval evidence. ECON-B1-v1 later supersedes OBL-B1-09, DLV-B1-04, and
# DLV-B1-07; the live consumer binds only the retained payloads in these first
# two sets and the complete author-approved economic successor below.
...
DELIVERY_PROSE_AGGREGATE_SHA256 = "eeff5e40301bfaf85b9a1b5eb81de6821c790117aebe923f513d5bcabf0b34fd"

ECONOMIC_PROSE_PAYLOADS = (
    ("ECON-B1-01", "book-1/08-what-you-are-owed.md", 5054, "ea166a02e26f99691b151b730258aa65a8d763be6ce29f02a9a83f19b883b119"),
    ("ECON-B1-02", "book-1/13-the-one-thing-taken.md", 541, "bee2c6504c7edd58c8ca2730bac7b4a18a1ac4d02b88cb2b6418f05bea6bfe3e"),
    ("ECON-B1-03", "book-1/14-when-the-system-notices-it-broke.md", 4411, "115e59dbc15acfc05324bdd34478132cbfd9ed54df9fb4f1eef937adbdfd66d7"),
)
ECONOMIC_PROSE_AGGREGATE_SHA256 = "e642322b7a787afb6adc7606c906b56e321385c5808a1418927e9239c6c2597d"
...
def validate_prose_payloads() -> None:
    ...
    if hashlib.sha256(b"\n\n".join(delivery_payloads)).hexdigest() != DELIVERY_PROSE_AGGREGATE_SHA256:
        raise RuntimeError("retained DLV-B1-v1 aggregate prose digest changed")
    economic_payloads = [
        _find_payload(ROOT / rel, length, digest)
        for _, rel, length, digest in ECONOMIC_PROSE_PAYLOADS
    ]
    if hashlib.sha256(b"\n\n".join(economic_payloads)).hexdigest() != ECONOMIC_PROSE_AGGREGATE_SHA256:
        raise RuntimeError("ECON-B1-v1 aggregate prose digest changed")
...
def check() -> None:
    ...
    print(
        ...
        f"{len(PROSE_PAYLOADS)} retained OBL-B1-v1, "
        f"{len(DELIVERY_PROSE_PAYLOADS)} retained DLV-B1-v1, and "
        f"{len(ECONOMIC_PROSE_PAYLOADS)} successor ECON-B1-v1 byte-exact prose payloads, "
