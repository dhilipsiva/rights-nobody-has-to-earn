...
landed, D2 and D3 hold for Parts I and II, and the rest wait for their items. The
...
(ruling D3); those of Parts I and II are written and the others are reserved
in `contents.json`. Book 2 remains inactive until Gate C and owns operation and
