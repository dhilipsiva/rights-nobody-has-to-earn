...
| `/read/<source-file-stem>/` | One of the complete reading inputs |
...
server implements the manifest. It generates **a route for every reading input
and three others**, and a separate 404 document; the three retired routes are
redirects, not extra HTML pages. Preserve trailing-slash URLs, fragments and
query strings.
