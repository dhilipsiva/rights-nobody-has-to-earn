...
const COUNTERFACTUAL_SPECS: [(&str, usize, usize); 68] = [
    ("no-person-line", 1, 0),
    ("no-public-court", 1, 0),
    ("no-choose-boss", 1, 0),
    ...
    ("no-obligations-independent-source-review", 40, 40),
    ("no-obligations-source", 40, 0),
    ...
    ("unnamed-office-integrity-kind", 0, 1),
    ("unnamed-political-finance-payer", 0, 1),
];
