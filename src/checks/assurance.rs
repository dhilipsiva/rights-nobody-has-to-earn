...
fn render(
    ...
    let mut lines = vec![
        ...
        "<!-- Generated by the native rights-verify record-integrity-assurance refresh; do not edit. -->"
            .to_owned(),
        String::new(),
        format!("# {}", source.title),
        String::new(),
    ...
    lines.extend([
        ...
        "- Regenerate after reviewing the JSON source with `./verify.sh --refresh record-integrity-assurance`; never hand-edit this report.".to_owned(),
        "- Run `./verify.sh --quick` for the structural freshness check.".to_owned(),
...
mod tests {
    ...
    fn renderer_matches_committed_report_byte_for_byte() {
        ...
        assert!(
            rendered.contains(
                "Generated by the native rights-verify record-integrity-assurance refresh"
            )
        );
        assert!(rendered.contains("`./verify.sh --refresh record-integrity-assurance`"));
