...
fn render(snapshot: &Snapshot) -> AuditResult<String> {
    ...
    let mut lines = vec![
        ...
        "<!-- Generated by new-book-plans/10-amendment-semantics.py; do not edit. -->".into(),
        String::new(),
        format!("# {}", source.title),
        String::new(),
    ...
    lines.extend([
        ...
        "- Regenerate: `python3 new-book-plans/10-amendment-semantics.py`.".into(),
        "- Fast structural/freshness check: `python3 new-book-plans/10-amendment-semantics.py --check`.".into(),
        "- Authoritative execution: `python3 new-book-plans/10-amendment-semantics.py --check --execute`.".into(),
...
mod tests {
    ...
    fn live_validation_and_report_are_byte_exact() {
        ...
        assert_eq!(
            render(&snapshot).expect("render").as_bytes(),
