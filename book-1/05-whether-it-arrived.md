...
The chapter on what you are owed ends where every entitlement in this design
ends: at a debt. This chapter is about the next thing, which the debt does not
contain — whether anything reached the person — and about the exact shape of
the evidence the design will accept before it concludes that it did. The
answer is deliberately narrow. A provider's own paperwork cannot certify that
the provider succeeded; a payment instrument is not a delivery; and an absence
of evidence is not a finding that delivery failed. What the record can say is
that a particular thing reached a particular person, when the person's side of
the record and an independent witness for that person say the same thing.

Everything in this chapter is a statement about what the supplied record can
establish. None of it is a finding about anybody's hunger, shelter, or care,
and none of it proves an actual-world arrival.
...
costs the most. Nell is owed everything and the record shows nothing
arriving, because the recipient-side route needs a receipt and a witness
...
This chapter establishes no offer, no accessible route, no adequate one, no
operation, and no actual arrival. A receipt with a witness derives that the
record says something reached a person; it does not authenticate the receipt,
the witness, or the thing, and it proves nothing about the service that
carried it. The recipient-side routes ship dormant in the shipped record, and
the only actualities that derive there still derive through the holding of a
person. Meal logistics, care workflow, facilities, staffing, procurement,
capacity, and every other operating question belong to the second book.
