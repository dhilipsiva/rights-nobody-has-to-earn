...
Ruk is here because of a hole that used to be open, and it is worth seeing what it
was.

In an earlier version of this design, severity was only consulted for domestic cases.
The reasoning had been about domestic violence specifically — an offender should not
be confined in the home where the person they harmed still lives — and the rule was
written to catch exactly that. Which meant that for a *non*-domestic offence, severity
was never examined at all.

So: commit an appalling non-domestic crime, have a home on record, and the machinery
routed you to home confinement. Not through a loophole anyone argued for. Through the
plain reading of a rule that had been written with a different case in mind.

The design's own commentary at the time said, confidently, that severe harm blocked
the soft option. It did not. The commentary described an intention and the rules
implemented something narrower, and nobody noticed, because reading a rule and reading
a description of a rule feel like the same activity and are not.

Severity now routes regardless of whether the offence was domestic. Ruk goes to high
security. The hole is closed, and the manner of its closing is the more useful lesson:
...
Two more things about the repaired alarm belong here, and the first is chapter 25's
...
elsewhere as a favour, and no moment at which anyone could have placed Hano in high
security out of dislike. The facts determine the outcome and the facts are on the
record where they can be disputed.

This matters more than it may sound. In systems where placement is assessed, the
