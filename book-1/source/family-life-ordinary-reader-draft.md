...
# What holding a role in somebody's life actually is — the exact Book 1 addition

Session-drafted, author-approved under delegated approval (2026-09-13). The
section below is inserted unchanged in
`book-1/09-the-vote-conviction-does-not-take.md`, between "Children, the
...
`book-1/appendix/contracts/family-life-ordinary-contract.md`.

Life course, family, care and reproduction was the last domain the reader ledger
showed only under strain, because the baseline landed 106 person-held barriers
and no ordinary-operation interface. The interface landed first and this passage
followed it, which is the required order: writing the passage first would have
fictionalised the coverage.
