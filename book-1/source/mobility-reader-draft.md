...
# Mobility and plurality reader additions — author-approved 2026-09-13

Session-drafted, author-approved under delegated approval (2026-09-13).
The author pre-approved all recommended suggestions after these exact passages
were displayed. They are now inserted at the placements below, including their
headings. Mechanical line wrapping does not change the wording. The
implementation contract is `mobility-and-plurality-contract.md`;
formal tests do not approve prose.

## Chapter 8 placement

Insert before "Owed is not the same as delivered":
...
Insert before "The home custody does not move":
