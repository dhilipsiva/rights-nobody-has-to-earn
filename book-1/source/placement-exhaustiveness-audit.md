...
<!-- Historical output of the retired placement refresh. -->

# Historical Placement Exhaustiveness Audit

This retained report describes the earlier raw-input routing and receipt-era
verification model. Its claims of currentness, automatic shelter, fixed secure
routing, fingerprints and acceptance gates are **superseded**, not present
assurance. The 2026-09-19 custody repair and 2026-09-20 severity decision govern
current law; see the [controlling decision](../appendix/decisions/public-safety-defence-emergency-and-external-power-decision.md).
The existing cases in `tests/pins/placement/` now supply qualified merits,
placement and intake and distinguish custody from shelter. Severe cases remain
eligible for home confinement, and their secure destination requires an
independent necessity finding. `tests/pins/custody/severity-boundary/` adds the
grave-harm, cruelty, ordinary-placement and rejected-ground comparisons.
Only the current `./verify.sh` result establishes their executed verdicts.
...
- Reviewed source: `book-1/source/placement-exhaustiveness-audit.json`.
- Constitution: `book-1/source/constitution.nibli` at SHA-256 `4018c6ccaa2ce39d8baa91bcbb936d6ed5e057ebf2a389798365e548bbc2da91`.
...
| --- | --- | ---: | ---: | --- |
| `duplicate-destination` | `duplicate_destination` | 1 | 1 | `b5e3773da2f9d8b6c49c1aecbd610f3cbfe00b4e96732b5ed7ce06a08cb2e7d7` |
| `historical-missing-dwell` | `historical_missing_dwell` | 1 | 1 | `d6a664f4bb1fcad4c137a24c9a1ad7a83cb6103cb9f7e2c059c13a780e684b57` |
| `missing-required-destination` | `missing_required_destination` | 2 | 2 | `db38ccb8fe004c9fb17feb0ecc1408f075483529dcbca17ce9bfefe0d9e8e373` |
| `opposite-destination` | `opposite_destination` | 4 | 2 | `6643ab62f12c90bf06111a2056eb0e958883b267a8c661633aff053d289292ab` |
| `painted-free-person-delivery` | `painted_free_person_delivery` | 16 | 16 | `71f32cecb318c7d59fe00f4e872f0227a4ef67dcd7366cffd6549b585ac1a67a` |
...
### `book-1/02-what-the-record-may-say.md::that someone has a family cannot worsen confinement.`
...
### `book-1/25-a-prisoner-is-a-person.md::shelter and recorded speech arrive for prisoners and for`
...
### `book-1/03-what-you-are-owed.md::The supplied record therefore still has a stark shape.`
...
### `book-1/26-where-people-are-put.md::The checks beside this book now make every combination`
...
### `book-1/27-the-one-thing-taken.md::The supplied record contains active floor actualities through punishment.`
...
### `book-1/28-when-the-system-notices-it-broke.md::The placement marker has since been repaired`
...
### `book-1/29-the-five-joints.md::The answer is the book's oldest honesty, sharpened.`
