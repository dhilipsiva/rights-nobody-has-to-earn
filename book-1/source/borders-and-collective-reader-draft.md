...
# When an asylum record contradicts itself, and when a consent was defective — the exact Book 1 additions
...
`book-1/08-what-you-are-owed.md`, between "Rights do not stop at arrival" and "A
way to be heard"; the second in
`book-1/09-the-vote-conviction-does-not-take.md`, between "Belonging without
surrendering rights" and "The home custody does not move". Their supporting
cases are listed in each chapter's pin file.

Borders, migration, asylum and expulsion and Collective and plurality rights
were each carried by a stated boundary alone. These are the passages in which
something goes wrong. They take the two shapes the mobility family actually
supports: a record that carries two values where one is allowed and therefore
stops completing, and a reviewed defect that withdraws a consent and the effect
built on it.
