...
[`state-form-and-political-membership-decision.md`](state-form-and-political-membership-decision.md),
...
- Source read in full: `book-1/source/constitution.nibli` at repository commit
...
3. **Several ruling texts still describe `mature` as live**, including
   `CLAUDE.md` and `closure-gaps-decision.md`, which still prints the
