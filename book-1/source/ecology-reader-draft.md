...
# Environmental and animal protection — exact reader additions

Supply: **session-drafted, author-approved** under the author's delegated
approval of 2026-09-13. These exact insertions are now in chapters 8, 9, 12
and 14 (with section headings promoted to chapter level), with the supporting
opening-note, Part V and method edits retained below. Complete verification
passed on 2026-09-14; the contract records the timing and evidence boundary.
The controlling legal contract is
[Environmental rights, commons and direct animal protection](ecological-and-animal-protection-contract.md).

## Chapter 8 — before “Owed is not the same as delivered”
...
## Chapter 12 — after the economic-constitution paragraphs
...
## Chapter 14 — before “And then nobody has necessarily acted”
...
## Opening note — replacement animal-coverage continuation
...
## Method — case-level implementation and evidence boundary
