...
supply that ground. The restriction must be the least restrictive effective
...
It may not target a viewpoint, belief or identity. The restricting body, reviewer
and challenge reader must remain separate.
...
gallery. Enforcement also requires prior notice, reasons and a usable challenge.
It takes no standing, floor, ballot entitlement or recognition.

The ordinary case runs in the other direction. A record establishing that no
restriction applies confers no public power to interfere; it obliges the public
...
Public information and its access and correction routes must be usable.
A refusal needs a reviewed ground and reasons, with any releasable part supplied.
Access cannot depend on explaining why you want it or paying an exclusionary fee.
Public bodies must use accessible formats and plain language, adjusted on request
without charge; no meaning may depend on one sense or notation alone.
Researchers and artists may publish or perform without prior approval. Public
power cannot dictate the question, method, result or content, and funding may not
buy a finding.

Concentration receives a different review, concerning ownership, distribution,
ranking and attention. That review cannot
establish whether anything published was true or well chosen. It opens a
...
expression supplies no recorded voice; a prohibition on coercing bodily choice
supplies no care receipt. The barrier rules protect freedom without establishing
