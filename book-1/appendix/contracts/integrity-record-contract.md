...
- [Money and influence](money-and-influence-contract.md), including payer identity.
- [Office integrity](office-integrity-contract.md).
- [Disclosure duties](disclosure-duty-contract.md).
- [Districting](districting-integrity-contract.md).
...
The reader projection is [Keeping public decisions answerable](../../09-the-vote-conviction-does-not-take.md#keeping-public-decisions-answerable)
