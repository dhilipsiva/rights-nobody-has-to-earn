...
> of `democratic-and-administrative-integrity-decision.md`; awaiting
...
The common `integrity-record-contract.md` also supplies a positive
...
- `book-1/source/state-form-source.json` — seventeen fields on each of 131
...
- `book-1/source/state-form.pins.nibli` — including FSACC-021.
- `book-1/source/counterfactual/unnamed-political-finance-payer.{,pins.}nibli`.
