...
Part V appointment argument (since item 59 argued in
[Chapter 17](../../17-how-public-power-is-built.md#argument-divided-without-deadlock))
...
- `state-form-and-political-membership-decision.md:205-208` — the
  incompatibility sentence and the divided-sources sentence.
- `state-form-and-political-membership-decision.md:210-211` — the
