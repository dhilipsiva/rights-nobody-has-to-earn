...
- `book-1/source/constitution.nibli` — the regenerated `OBLIGATIONS-RULES`
  block.
- `book-1/source/obligations.pins.nibli` and the four delegated counterfactual
  files, all generated.
- `book-1/source/full-society-ledger.json` — FS-CCE-387..390 and FS-CVF-016
