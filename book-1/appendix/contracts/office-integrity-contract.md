...
> `democratic-and-administrative-integrity-decision.md`, including the
...
`integrity-record-contract.md` additionally supplies an independently
...
- `book-1/source/state-form-source.json` — eleven fields on each of 131
  branches; the only hand-edited member of the family.
- `book-1/source/constitution.nibli` — the regenerated `STATE-FORM-RULES`
  block: 291 statements.
- `book-1/source/state-form.pins.nibli` — 396 main pins, including FSACC-020.
- `book-1/source/counterfactual/unnamed-office-integrity-kind.{,pins.}nibli` —
...
- `book-1/source/economic-power-{062,071,072,073,074,075,076,077,084,085,088}.pins.nibli`
...
6. **No derived prose in this batch.** The anti-capture batch set the
   ...
   `book-1/24-findings-about-people.md` is drafted below for approval; if
