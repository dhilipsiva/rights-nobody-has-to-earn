...
The record can say that Nell was born. It cannot add a free-form description
...
There is no general constitutional field for reliability, deservingness,
productivity or predicted risk. An institution cannot add one merely by
...
record takes the narrow, challengeable result needed for the specified purpose,
...
to enter a vulnerability classification, which is refused. Nell's protection
