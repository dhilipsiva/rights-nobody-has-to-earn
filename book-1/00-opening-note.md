...
I propose a constitution in which being a person gives standing in law and
...
is harder to locate. Equal standing alone does not show that this is the
...
available beside the text for anyone who wants to inspect them.

The first case is a child with nobody. Here that phrase describes a test
record, not a child's feelings or actual circumstances. There is a birth
entry, but no recorded parent, household or other private provider; no chosen
supporter or challenge made on the child's behalf; and no public act such as
arrest or placement that would ensure the child appeared in an official case.
Remove even the birth entry and the rules have nothing to read. The test asks
whether protection waits for any of those things, and who must begin help
when the person cannot ask.

My argument is that this is a good place to begin designing for everyone.
...
The prisoner supplies the paired test. Public power has acted on this person,
and the record contains the case and authority for holding them. Does the
...
the method only if you want to inspect how the rules are run and tested.
...
What that companion returns are answers about the records given to it; it is
not evidence that any society delivered anything.
...
The [epigraph](epigraph.md) precedes this opening. The numbered chapters form
the main reading sequence; the method follows it as an optional technical part.

### Part I — Who counts, and what they are owed

- [Chapter 1: The Child With Nobody](01-the-child-with-nobody.md) — what follows
  from a birth entry, and what remains invisible when no entry exists.
- [Chapter 2: Who Counts](02-who-counts.md) — personhood without papers,
  citizenship or a family.
- [Chapter 3: What Counts as Evidence](03-what-counts-as-evidence.md) — which
  entries the rules accept, and what a temporary encounter name cannot prove.
- [Chapter 4: What You Are Owed](04-what-you-are-owed.md) — the floor and the
  difference between entitlement and fulfilment.
- [Chapter 5: Whether It Arrived](05-whether-it-arrived.md) — recipient-side
...
- [Chapter 7: Who Owes, and What Follows](07-who-owes-and-what-follows.md) — public
...
- [Chapter 13: A Place in Which Life Remains Possible](13-a-place-in-which-life-remains-possible.md)
  — ecological limits, future conditions and animals' own interests.
...
- [Chapter 29: The One Thing Taken](29-the-one-thing-taken.md) — limits on custody,
  protective powers and what actual release requires.
- [Chapter 30: When the System Notices It Broke](30-when-the-system-notices-it-broke.md)
...
- [Chapter 31: The Five Joints](31-the-five-joints.md) — the argument over
...
- **The State and the constitutional bodies:** the record's `State` owes the
  ...
  See Chapters [4](04-what-you-are-owed.md),
  [7](07-who-owes-and-what-follows.md) and [17](17-how-public-power-is-built.md).
...
- **The electorate and convocation:** separate sources of seating, and so of
  ...
  [16](16-public-answerability.md) and [23](23-who-holds-the-pen.md).
...
- **The court:** records a judgment. That alone gives no current authority to
  confine. See Chapters [24](24-the-shield.md) and
...
- **The timing service and the temporal witnesses:** give separately scoped
  ...
  or continued arrival. See Chapters [3](03-what-counts-as-evidence.md),
  [23](23-who-holds-the-pen.md) and [29](29-the-one-thing-taken.md).
...
| Marisol, with a food receipt and a matching observation by an independent witness | What shows that provision arrived? | [5](05-whether-it-arrived.md) |
...
| Esa, a teacher and the child of a parent who judges Esa | What does an activity or family relationship show about age? | [10](10-contribution.md), [18](18-the-vote-conviction-does-not-take.md) |
| Nima, Pico's parent and teacher; Pico, also a teacher of Ona; Sata, with an employment entry naming care; Quin, who did the census | Whose contribution is recorded? | [10](10-contribution.md) |
| Yano, who examines Adam and cites a ground | Does citing a ground give the authority to sign? | [10](10-contribution.md) |
| Koa, with a recorded examination of Esa but no public answerability | Does an examination make its author answerable, or an auditor? | [16](16-public-answerability.md) |
| Tove, a recalled official; Iris, who exposed Tove | Why does answerability survive recall? | [16](16-public-answerability.md) |
...
| Gia and Wren, holding the authority to sign through different seating bodies | Who may sign a credibility finding? | [23](23-who-holds-the-pen.md) |
| Mael, seated, but denied the authority to sign by a finding from an earlier version of the record, kept in the version in force | Why does personal restoration leave a separate appointment restriction? | [23](23-who-holds-the-pen.md), [26](26-clawback.md) |
| Faro, defendant and discloser; Pax, injured person and disclosure target | Does exposing a private person open the shield? | [24](24-the-shield.md#faro-a-private-target) |
| Lior and Kel, defendants exposing the court in separate cases | What changes when this exposure has a properly made deceit finding? | [24](24-the-shield.md#lior-an-unresolved-disclosure) |
| Dara, defendant with two disclosures; Sena, injured person | Can a finding about one disclosure defeat another, or the prosecution proceed separately? | [24](24-the-shield.md#dara-a-separate-exposure) |
| Saba, who examines Bela with Gia | What must a paired credibility finding contain? | [25](25-voiding.md) |
| Dev, Esa's parent, who judges Esa | What does a family tie bar, and what needs a separate case? | [25](25-voiding.md) |
| Edo, subject of a finding for deceiving Mira, then a proposed examiner | Can earlier clearance override a current restriction on signing? | [25](25-voiding.md) |
| Tyr, the subject of a finding proposed by Mael and Wren | Can a signer restricted by a finding from an earlier version of the record join a new one? | [25](25-voiding.md) |
| Fin, taught by Esa, with no personhood entry | Does a teaching relationship answer a question about standing? | [26](26-clawback.md) |
| Zed, subject of a properly made custody case; Ivo, injured person | Does custody preserve standing without another recorded root? | [27](27-a-prisoner-is-a-person.md) |
| Ruk, with a finding of grave injury to Opal; Lalo, with a finding of aggravated cruelty; both with authorised secure placements | What makes an offence severe, and does severity choose the place? | [28](28-where-people-are-put.md) |
| Ruk, eligible for home confinement but authorised for a secure place | Which reported placements conflict with the authority in force? | [28](28-where-people-are-put.md), [30](30-when-the-system-notices-it-broke.md) |
| Nando, with no home option recorded and a reviewed supported residence | Does a missing home entry decide where a person is held? | [28](28-where-people-are-put.md) |
| Adam and Kel, with reviewed supported residences | Why is a placement record not a shelter receipt? | [28](28-where-people-are-put.md), [29](29-the-one-thing-taken.md) |
| Hano, held under a properly made custody case | What is required to restrict movement, and what remains protected? | [18](18-the-vote-conviction-does-not-take.md), [29](29-the-one-thing-taken.md) |
| Jala, with a recorded injury to Ivo but no conviction | Does sharing an injury entry with a convicted person's case restrict movement? | [29](29-the-one-thing-taken.md) |

Historical cases belong to Part V's arguments over
[valuation](31-the-five-joints.md#valuation),
[rotation](31-the-five-joints.md#rotation),
[coercion](31-the-five-joints.md#coercion),
[capture](31-the-five-joints.md#capture) and
[the state](31-the-five-joints.md#the-state).
...
|---|---|
| Personhood and life course | [Standing](02-who-counts.md), [care and agency](14-holding-a-role-in-somebodys-life.md), [adulthood](18-the-vote-conviction-does-not-take.md) |
...
| Emergencies, security and defence | [Crises](20-a-crisis-does-not-suspend-the-republic.md), [protective powers](29-the-one-thing-taken.md) |
| Equality and discrimination | [Equal routes, accommodation and remedy](12-the-same-route-for-everyone.md) |
| Environment, future conditions and animals | [Ecological rights and animal protection](13-a-place-in-which-life-remains-possible.md) |
| Friendship, leisure, mutual aid and associations | [Private and civic freedom](08-what-nobody-has-to-ask-permission-for.md), [voluntary provision](07-who-owes-and-what-follows.md), [relationships](14-holding-a-role-in-somebodys-life.md) |
