...
the reasons before the institutional detail, the [map of choices](reference.md#the-choices-and-their-arguments)
at the back of the book leads directly to them, beside the glossary, the
contents and the index. Continue to the method only if you want to inspect how
the rules are run and tested.
