...
The floor chapter says what every person is owed, and the arrival chapter
says what evidence the record will accept before it agrees that anything
reached anybody. This chapter is the third question, and it is the one a
person actually asks when something has gone wrong: who has to answer, and
what follows once a finding exists.

The answers below are legal conclusions over supplied records. A duty here is
a statement that somebody must answer, never a record that anybody did.

## The forms public responsibility takes

The floor chapter names the body that owes and says the debt runs to every
person. What that responsibility actually consists of is this chapter's first
question, and the forms are held apart because they fail in different ways.
...
## Duties do not all run to the same place
...
## An excuse has to arrive as a record
...
## Civic duties, and what their breach cannot reach
...
A later chapter tells how a recorded violation produces a duty on a review
body, and how much of that duty's quality it inherits from whatever signal
produced it. What becomes of the duty once it exists is this chapter's
business.
...
## The lifecycle, and the record each step needs
...
## Silence at a review supplies nothing
...
that is the point of the reverse boundary above: no household, relationship,
association or charity is presumed to provide another person's floor, so the
absence of all of them subtracts nothing from what is owed. The public duty
