...
and automated support cease to follow. The duties attached to those records
...
The record can name its subject without recording that subject as a person.
The case completes without creating personhood, a credibility finding or
confinement for that name. Hano's floor and ballot conclusions remain. The
legal standing routes are separate from permission to hold or process records;
a file is not a source of human worth or a licence to reduce rights.
...
a criminal burden, and gives no verdict about what one person deserves,
