...
is not a thing this record can hold. That is chapter 2's discipline doing exactly what
...
are harder to forge. Chapter 4 is where that distinction is argued; it matters here
...
To reach a person you need two, independently, both examining and both recording.
Corruption becomes a conspiracy problem rather than an individual one, and
conspiracies are harder to arrange and much harder to keep quiet.

The rest of the conditions exist because "two" is easier to fake than it sounds.
...
and everyone moves on; the cost of trying is roughly zero, so trying is roughly free.
Here the cost of an improper finding falls on the person who made it. You cannot
fish. The attempt is itself the offence.

It is worth being precise about what this does and does not achieve. It does not
prevent a corrupt auditor from making one attempt. Nothing can. What it does is make
