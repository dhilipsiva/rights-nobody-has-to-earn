...
Ask how much recognition Esa has.
...
And you cannot price anything in it. There is no rule anywhere of the form *this
costs so much recognition*, because "so much" is not expressible.

This is the design's answer to a problem that has ruined nearly every attempt at
something like it. Build a system that acknowledges contribution, attach a number to
the acknowledgement, and you have built a currency — whatever you call it, whatever
you forbid people to do with it. Numbers are comparable, so people get ranked. Ranks
become entitlements. Entitlements become tradeable. Within a generation the society
has an aristocracy of the highly-recognised, and the fact that nobody intended one is
...
trouble you. Degree is perfectly available here. Chapter 3 showed how: the severity
...
one, and chapter 3 put it on the table rather than leave it to be found: whether an
