...
has a different record and purpose. The distinction matters most when someone
contributes without pay, or loses recognition while keeping their ordinary
rights.
...
neither supplies those protections nor proves they operated.

## There is no number

Esa is recognised. The relation has no place for a quantity, balance or source
of recognition. Teaching another person can support the same conclusion, but
cannot increase it. There is no recognition transfer, price or purchase rule.
...
follows. Any supplied ground can fill that place: the rule requires a stated
reason but does not establish its truth or adequacy. It also does not require
Yano to hold the authority needed to make an examination count toward voiding.
Recognition for an examination and power over its subject are separate claims.

Boss's examination supplies another boundary. Even with its ground recorded,
it earns no recognition because Boss is recalled. Recall and voiding are
separate conditions; neither is inferred merely from the other.

Recognising examination can encourage attention to other people's conduct,
including unwelcome attention. No extra recognition follows from conviction,
and an improper finding can expose an examiner to accountability. Those limits
do not establish how much scrutiny the institution would encourage or whether
its subjects would be adequately protected. The later account of auditors must
answer for the powers it gives them; an unspendable acknowledgment is not that
answer.
...
can never become coercive, that records cannot be misused, or that every
unpaid contribution receives acknowledgment. Those would be claims about
institutions and conduct beyond the conclusion tested here.

The distinction carried forward is between acknowledging a contribution and
allowing it to purchase power. The next chapter asks what money itself may
buy, and where that permission ends.
