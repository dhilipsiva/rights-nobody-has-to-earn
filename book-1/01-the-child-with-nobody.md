...
The record says that Nell was born. It names no parent, family, home,
...
against a registry. Nell therefore enters the design as a person. The other
missing entries are not conditions waiting to be satisfied.
...
the birth entry. There is no smaller entitlement pending a relative's arrival
or a later registration.
...
A family entry would not show that somebody fed, housed or cared for Nell.
The rules expressly prevent a household, relative, association or charity from
...
Personhood also sets limits on power. Children hold rights independently.
...
rights office a duty to review whether it was initiated. The passerby needs no
seat, authorisation or relationship to Nell. The entry proves neither a breach
nor an incapacity and gives no ground for punishment.

A distinct care-continuity case shows what a more specific public duty requires.
Its record identifies the authorised actor and the care matter; no parent,
caregiver, household or supporter has to hold a role. The duty does not grant
the public actor parentage or authority over every aspect of the person's life.
...
duty does not follow here. The duty to initiate assistance does. The requirement
...
neither. Another test records those entries for a person outside custody,
and the delivery conclusions follow. The difference is the evidence of
receipt, not a different entitlement.
...
The rules conclude no personhood for Ori, and consequently no floor entitlement
or duty to begin assistance. That is a failure to reach a person through the
record, not a finding that Ori is not human or should be denied help.
A birth or encounter entry would open the route. Until then, the rules have
nothing about Ori to read.

The internal breach markers do not find Ori either. A marker that reads
confinement does not apply. Even a test rule flagging every recorded person
without evidence of food would reach Nell and miss Ori: it still begins with
a person the record can identify. A wider entry rule cannot by itself observe
someone outside every entry.

A deliberately altered design makes a separate dependency visible. Suppose the
birth rule were deleted while Nell's birth entry stayed. Personhood would then
fail to follow for Nell, and so would the entitlements and protections that
depend on it. The retained internal markers raise no alarm about that loss.
The ordinary test requiring personhood after a birth would reject this altered
design, but nothing in the rules raises that failure as an alarm.

These are different failures to reach the case. Ori lacks an entry; in the
altered design, Nell lacks the rule that reads one. Neither is solved by
assuming a family or requiring the child to ask.
