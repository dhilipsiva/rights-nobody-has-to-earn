...
Parts I and II have their opening cases and their chapters' argument sections;
the other Parts' cases are reserved in `contents.json` until they are written.
